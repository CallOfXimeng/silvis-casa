...
其中$\hat{y}_i=f(\boldsymbol{a}; x_i)$为待拟合的函数，包含$m$个参数$a_1,a_2,\cdots a_m$。对于线性拟合，$\hat{y_i}=k\cdot x_i+b$，对于更一般的情况，$f$的形式更复杂。我们可以预计，对于任意一组$\boldsymbol{a}$，只要$\boldsymbol{a}$还没有满足最佳拟合，误差$err$就还不是最小的。因此拟合的本质就是求取一组$\boldsymbol{a}$使得误差函数最小。求函数的最小值可以通过求一阶导与二阶导数得到，但是这个方法可以更加无脑一些。比如我们看一个简单的函数图像
![image](https://user-images.githubusercontent.com/31767235/202130330-75a3610f-a52d-44c1-a16e-51c32a4dc830.png){:height="50%" width="50%"}
...
![image](https://user-images.githubusercontent.com/31767235/202130417-dfe776fd-6b95-4291-9c60-13927fcf52e9.png){:height="50%" width="50%"}
